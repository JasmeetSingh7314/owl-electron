...
import { createUser, getAllUsers } from '@renderer/api/user/createUser'
    ...
    <>
      ...
      >
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="font-bold text-3xl font-urbanist">Create Wallet</ModalHeader>
              <ModalBody>
                  ...
                  <div className="generate_mnemonic_box flex flex-col gap-x-5">
                    <div className="generate_mnemonic_desc">
                      <h1 className="text-red-400">
                        COPY THESE VALUES FOR FUTURE REFERENCE!!! Make sure to copy this mnemonic
                        phrase as it will be used to import the wallet.
                      </h1>
                    </div>
                      ...
                      <div className="generate_mnemonic_content_box">
                        ...
                        <div className="content_box">
                          ...
                          <div className="flex justify-between w-full rounded-md border border-[rgba(255,255,255,0.4)] bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 disabled:cursor-not-allowed disabled:opacity-50">
                            <p>
                              {' '}
                              <p>{`${publicKey?.slice(0, 15)}...${publicKey?.slice(
                                publicKey.length - 15
                              )}`}</p>
                            </p>
                            <FaCopy
                        ...
                        <div className="content_box">
                          ...
                          <div className="flex justify-between w-full rounded-md border border-[rgba(255,255,255,0.4)] bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 disabled:cursor-not-allowed disabled:opacity-50">
                            <p>
                              {' '}
                              <p>{`${secretKey.slice(0, 15)}...${secretKey.slice(
                                secretKey.length - 15
                              )}`}</p>
                            </p>
                            <FaCopy
