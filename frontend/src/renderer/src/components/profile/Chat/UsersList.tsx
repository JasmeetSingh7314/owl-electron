import { useChatStore } from '@renderer/store/store'
import { users } from '@renderer/utils/dummydata/chatdummyDb'
      ...
      {users.map((element, id) => (
        ...
        >
          ...
          <div className="w-full space-y-1">
            <div className="text-lg font-semibold text-left">{element.name}</div>
