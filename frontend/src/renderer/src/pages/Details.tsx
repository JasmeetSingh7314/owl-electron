...
import GameDetails from '@renderer/components/Detailpanel/GameDetails'
import TextSection from '@renderer/components/Detailpanel/TextSection'
import Footer from '@renderer/components/Home/Footer'
import { useParams } from 'react-router-dom'
import { useGetVideos } from '@renderer/hooks/useGetVideos'
import Suggestions from '@renderer/components/Detailpanel/Suggestions'
      ...
      <section className="flex flex-col  2xl:px-36 medium:px-48 extra:px-60">
        ...
        <div className="px-2 py-4 flex mb-5 justify-between flex-col sm:px-30 md:px-10 h-max">
          ...
          {detailsResponse?.isLoading || videoResponse?.isLoading ? (
            ...
            <div>
              <GameDetails data={detailsResponse?.data[0]} video={videoResponse?.videoRef} />
